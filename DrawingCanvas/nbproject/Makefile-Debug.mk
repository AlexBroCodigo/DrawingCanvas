...
${OBJECTDIR}/ArbolAvlUsuarios.o: ArbolAvlUsuarios.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArbolAvlUsuarios.o ArbolAvlUsuarios.cpp

${OBJECTDIR}/ArbolCapas.o: ArbolCapas.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArbolCapas.o ArbolCapas.cpp

${OBJECTDIR}/ListaCabeceras.o: ListaCabeceras.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaCabeceras.o ListaCabeceras.cpp

${OBJECTDIR}/ListaCircularImagenes.o: ListaCircularImagenes.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaCircularImagenes.o ListaCircularImagenes.cpp

${OBJECTDIR}/ListaHorizontal.o: ListaHorizontal.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaHorizontal.o ListaHorizontal.cpp

${OBJECTDIR}/ListaLaterales.o: ListaLaterales.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaLaterales.o ListaLaterales.cpp

${OBJECTDIR}/ListaSimpleCapas.o: ListaSimpleCapas.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaSimpleCapas.o ListaSimpleCapas.cpp

${OBJECTDIR}/ListaSimpleImagenes.o: ListaSimpleImagenes.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaSimpleImagenes.o ListaSimpleImagenes.cpp

${OBJECTDIR}/ListaTopImagenes.o: ListaTopImagenes.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaTopImagenes.o ListaTopImagenes.cpp

${OBJECTDIR}/ListaTopUsuarios.o: ListaTopUsuarios.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaTopUsuarios.o ListaTopUsuarios.cpp

${OBJECTDIR}/ListaVertical.o: ListaVertical.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaVertical.o ListaVertical.cpp

${OBJECTDIR}/MatrizCapa.o: MatrizCapa.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MatrizCapa.o MatrizCapa.cpp
